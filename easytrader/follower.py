...
class BaseFollower(object):
    ...
    def login(self, user, password, **kwargs):
        ...
        headers = {
            ...
            'Cookie':'s=fk110i3xzo; device_id=9ffb09be00d5ac63ad562e9f94b1008d; remember=1; remember.sig=K4F3faYzmVuqC0iXIERCQf55g2Y; xq_a_token=ea882786a407c50fa22117dea42a5a58c34f1c42; xq_a_token.sig=v2aB9eVlZyGCq9LuWc9gKn0-lRY; xq_r_token=40425938f2e412d5f5604e62618d15a96e5759e0; xq_r_token.sig=PUJqjCd5HjcjSGLscJzwD58dibY; xq_is_login=1; xq_is_login.sig=J3LxgPVPUzbBg3Kee_PquUfih7Q; u=4382927175; u.sig=v2hrXgFxyYY_ybd88qNgrch6nYk; bid=9873db07c633521de9081374178e8b75_jemmecyj; aliyungf_tc=AQAAAP3khEmSeAcAsCLtdDjbKLb+2vH/; Hm_lvt_1db88642e346389874251b5a1eded6e3=1520761950,1520765441,1520778683,1520818093; Hm_lpvt_1db88642e346389874251b5a1eded6e3=1520822051; __utmt=1; __utma=1.1255153991.1520758937.1520818093.1520822051.5; __utmb=1.1.10.1520822051; __utmc=1; __utmz=1.1520758937.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none)',
